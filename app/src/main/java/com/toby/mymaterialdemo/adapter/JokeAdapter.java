...
import com.toby.mymaterialdemo.listener.OnRecyclerViewItemClickListener;
import com.toby.mymaterialdemo.model.BaiSiResult;
import com.toby.mymaterialdemo.ui.activity.ImagesDetailActivity;
import com.toby.mymaterialdemo.widgets.CircleImageView;
...
public class JokeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final BaiSiResult.ListBean listBean = baiSiResultList.get(position);
        ...
        if (listBean != null) {
            ...
            if (holder instanceof ImageViewHolder) {
                ...
                ((ImageViewHolder) holder).image0.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        imageClick(listBean, view, position);
                    }
                });
